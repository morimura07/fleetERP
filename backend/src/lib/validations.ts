...
export const goodsReceiptSchema = z.object({
  ...
  // Gate entry and delivery note (client requirements, Sept 2026, Procurement §5).
  gateEntryNo: z.string().max(40).optional().or(z.literal("")),
  gateEntryAt: z.coerce.date().optional().nullable(),
  deliveryNoteNo: z.string().max(60).optional().or(z.literal("")),
