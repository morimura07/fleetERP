...
import { attachments } from "@backend/routes/attachments";
import { imports } from "@backend/routes/imports";
import { parties } from "@backend/routes/parties";
...
import { requisitions } from "@backend/routes/requisitions";
import { sourcing } from "@backend/routes/sourcing";
import { shipments } from "@backend/routes/shipments";
import { supplier } from "@backend/routes/supplier";
...
app.route("/api/requisitions", requisitions);
app.route("/api/rfqs", sourcing);
app.route("/api/shipments", shipments);
app.route("/api/supplier", supplier);
