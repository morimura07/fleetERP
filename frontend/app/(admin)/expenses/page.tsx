...
export default async function ExpensesPage() {
  const { drivers, advances, vehicles, trips } = await serverApi<ExpenseForm>("/api/lookups/expense-form");
  return (
    <div className="space-y-6">
      ...
      <ExpensesManager drivers={drivers} advances={advances} vehicles={vehicles} trips={trips} />
    </div>
  );
}
