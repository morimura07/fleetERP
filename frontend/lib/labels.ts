...
export const SHIPMENT_MODE_LABEL: Record<ShipmentMode, string> = { SEA: "Sea", AIR: "Air", ROAD: "Road", RAIL: "Rail", COURIER: "Courier" };
export const SHIPMENT_STATUS_LABEL: Record<ShipmentStatus, string> = { PLANNED: "Planned", IN_TRANSIT: "In transit", ARRIVED: "Arrived", CLEARING: "Clearing", CLEARED: "Cleared", DELIVERED: "Delivered", CANCELLED: "Cancelled" };
export const SHIPMENT_STATUS_VARIANT: Record<ShipmentStatus, BadgeVariant> = { PLANNED: "secondary", IN_TRANSIT: "info", ARRIVED: "info", CLEARING: "warning", CLEARED: "info", DELIVERED: "success", CANCELLED: "destructive" };
export const CLEARANCE_STATUS_LABEL: Record<ClearanceStatus, string> = { NOT_STARTED: "Not started", DOCS_LODGED: "Documents lodged", ASSESSED: "Duty assessed", DUTY_PAID: "Duty paid", RELEASED: "Released", HELD: "Held" };
export const SHIPMENT_DOC_LABEL: Record<ShipmentDocType, string> = { TRANSPORT_DOCUMENT: "Bill of lading / air waybill", COMMERCIAL_INVOICE: "Commercial invoice", PACKING_LIST: "Packing list", CERTIFICATE_OF_ORIGIN: "Certificate of origin", INSURANCE_CERTIFICATE: "Insurance certificate", IMPORT_PERMIT: "Import permit", CUSTOMS_DECLARATION: "Customs declaration", RELEASE_ORDER: "Release order", OTHER: "Other" };
export const GRN_STATUS_LABEL: Record<GrnStatus, string> = { RECEIVED: "Received, inspection pending", INSPECTING: "Inspecting", COMPLETED: "Inspection complete" };
export const QA_STATUS_LABEL: Record<QaStatus, string> = { PENDING: "Pending", PASSED: "Passed", FAILED: "Failed", QUARANTINE: "Quarantine" };
export const QA_STATUS_VARIANT: Record<QaStatus, BadgeVariant> = { PENDING: "secondary", PASSED: "success", FAILED: "destructive", QUARANTINE: "warning" };
export const RTV_STATUS_LABEL: Record<RtvStatus, string> = { OPEN: "Open", SHIPPED: "Shipped back", CREDITED: "Credited", CLOSED: "Closed" };
export const RTV_STATUS_VARIANT: Record<RtvStatus, BadgeVariant> = { OPEN: "warning", SHIPPED: "info", CREDITED: "success", CLOSED: "secondary" };
