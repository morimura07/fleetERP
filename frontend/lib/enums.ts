...
export type PurchaseOrderStatus = "DRAFT" | "PENDING_APPROVAL" | "APPROVED" | "ISSUED" | "ACKNOWLEDGED" | "IN_PRODUCTION" | "DISPATCHED" | "PARTIAL" | "RECEIVED" | "CLOSED" | "CANCELLED";
export type AvlStatus = "PENDING" | "APPROVED" | "SUSPENDED";
export type AvlRegion = "LOCAL" | "REGIONAL" | "INTERNATIONAL";
...
export type ShipmentStatus = "PLANNED" | "IN_TRANSIT" | "ARRIVED" | "CLEARING" | "CLEARED" | "DELIVERED" | "CANCELLED";
export type ClearanceStatus = "NOT_STARTED" | "DOCS_LODGED" | "ASSESSED" | "DUTY_PAID" | "RELEASED" | "HELD";
export type ShipmentDocType = "TRANSPORT_DOCUMENT" | "COMMERCIAL_INVOICE" | "PACKING_LIST" | "CERTIFICATE_OF_ORIGIN" | "INSURANCE_CERTIFICATE" | "IMPORT_PERMIT" | "CUSTOMS_DECLARATION" | "RELEASE_ORDER" | "OTHER";
export type GrnStatus = "RECEIVED" | "INSPECTING" | "COMPLETED";
export type QaStatus = "PENDING" | "PASSED" | "FAILED" | "QUARANTINE";
export type RtvStatus = "OPEN" | "SHIPPED" | "CREDITED" | "CLOSED";
